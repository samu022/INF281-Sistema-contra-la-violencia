...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2023 a las 06:16:53
...
CREATE TABLE `alerta` (
  ...
  `codGeo` varchar(20) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `contacto_emeergencia`
--

CREATE TABLE `contacto_emeergencia` (
...
CREATE TABLE `denuncia` (
  ...
  `descripcion` varchar(20) DEFAULT NULL,
  `testigo` varchar(20) DEFAULT NULL,
...
CREATE TABLE `evaluacion_riesgo` (
  ...
  `url_cuestionario` varchar(20) DEFAULT NULL,
  `consejo` varchar(20) DEFAULT NULL,
  `ci` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `informacion_educativa` (
  ...
  `rutaDirectorio` varchar(20) DEFAULT NULL,
  `tipo` varchar(20) DEFAULT NULL,
  `ci` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `victima` (
  `ci` int(11) NOT NULL,
  `relacion_perpetrador` varchar(20) DEFAULT NULL,
...
--
-- Indices de la tabla `contacto_emeergencia`
--
ALTER TABLE `contacto_emeergencia`
...
--
-- Filtros para la tabla `contacto_emeergencia`
--
ALTER TABLE `contacto_emeergencia`
  ADD CONSTRAINT `contacto_emeergencia_ibfk_1` FOREIGN KEY (`ci_contacto`) REFERENCES `persona` (`ci`) ON DELETE CASCADE;
...
ALTER TABLE `tiene`
  ...
  ADD CONSTRAINT `R_9` FOREIGN KEY (`ci_contacto`) REFERENCES `contacto_emeergencia` (`ci_contacto`);
