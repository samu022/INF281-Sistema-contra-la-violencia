...
VALUES
  (1, 'Activa', '2023-09-06', 10007, 1),
  (2, 'Inactiva', '2023-08-06', 10008, 2),
  (3, 'Activa', '2023-10-07', 10007, 3),
  (4, 'Inactiva', '2023-08-14', 10007, 4),
  (5, 'Activa', '2023-10-11', 10008, 5);
...
VALUES
  ...
  (2, 'Acoso Sexual', 'Acoso en el trabajo', 'Luisa Rodríguez', 'En investigación', '2023-12-06', 2),
  (3, 'Violencia de Género', 'Amenazas verbales', 'María García', 'Cerrada', '2023-01-06', 3),
  (4, 'Violencia Doméstica', 'Violencia psicológica', 'Carlos López', 'En proceso', '2023-01-12', 4),
  (5, 'Acoso Sexual', 'Acoso callejero', 'Pedro Martínez', 'En proceso', '2023-02-18', 5);
...
VALUES
  (1, '2023-09-06', '10:15 AM', 'Hola, ¿cómo estás?', 10007),
  (2, '2023-09-06', '11:30 AM', 'Estoy bien, gracias. ¿Y tú?', 10008),
  (3, '2023-09-06', '12:45 PM', 'Todo va bien por aquí. Nos vemos luego.', 10007);
