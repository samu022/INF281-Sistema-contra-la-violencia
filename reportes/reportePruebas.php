...
$pdf->SetTitle('Reporte de pruebas');
...
$pdf->Cell(100,6,'LISTA DE PRUEBAS REGISTRADAS',0,0,'B');
...
<table border="1" cellspacing="0" cellpadding="5">
    <tr>
        ...
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 20%;">codPrueba</th>
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 30%;">tipo</th>
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 40%;">descripcion</th>
    </tr>';
...
while ($dataRow = mysqli_fetch_array($query)) {
    ...
    $tableHtml .= '
        <tr bgcolor="' . $filaColor . '">
            ...
            <td style="border: 1px solid #000;">' . $dataRow['codPrueba'] . '</td>
...
$pdf->Output('reporte_pruebas'.date('d_m_y').'.pdf', 'I'); 
