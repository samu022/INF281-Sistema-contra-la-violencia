    ...
    <section class="form-register">
      ...
      <form action="" class="formulario" method="POST">
        ...
        <div class="formulario__grupo-input">
            ...
            <textarea class="descripcion" name="form_fields[message]" id="form-field-message" rows="4" placeholder="Describa las pruebas aqui." required="required" aria-required="true"></textarea>
        </div>
    </form>
