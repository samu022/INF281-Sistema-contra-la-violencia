...
$pdf->Cell(100,6,'LISTA DE USUARIOS',0,0,'B');
...
<table border="1" cellspacing="0" cellpadding="5">
    <tr>
        ...
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 25%;">ci</th>
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 35%;">nombreUsuario</th>
        <th style="background-color: #0073e6; color: #fff; border: 1px solid #000; width: 35%;">correo</th>
    </tr>';
...
while ($dataRow = mysqli_fetch_array($query)) {
    ...
    $tableHtml .= '
        <tr bgcolor="' . $filaColor . '">
            ...
            <td style="border: 1px solid #000;">' . $dataRow['ci_usuario'] . '</td>
...
$pdf->Output('reporte_usuarios'.date('d_m_y').'.pdf', 'I'); 
