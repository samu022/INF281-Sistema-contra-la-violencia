...
<body>
    <div>
        ...
        <div class="">
            <button type="submit" class="btn btn-success mb-2">Reporte de Denuncias</button>
        </div>
        </form>
        <form action="../reportes/reporteVictimas.php" method="post" accept-charset="utf-8">
            <div class="">
                <button type="submit" class="btn btn-success mb-2">Reporte de victimas</button>
            </div>
        </form>
        <form action="../reportes/reporteAgresores.php" method="post" accept-charset="utf-8">
            <div class="">
                <button type="submit" class="btn btn-success mb-2">Reporte de agresores</button>
            </div>
        </form>
        <form action="../reportes/reporteDenunciaDetallada.php" method="post" accept-charset="utf-8">
        <div class="">
            <button type="submit" class="btn btn-success mb-2">Reporte de denuncia detallada</button>
        </div>
    </form>
        </div>
